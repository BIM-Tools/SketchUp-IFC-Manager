...
module BimTools
 module Zip
  ...
  #   require 'zip'
  #
  #   BimTools::Zip::OutputStream.open("my.zip") do |io|
  #
  ...
  #
  #
  #   BimTools::Zip::InputStream.open("my.zip") do |io|
  #
  ...
  class InputStream
    ...
    class << self
      ...
      def open_buffer(filename_or_io, offset: 0)
        ...
        ::BimTools::Zip::InputStream.open(filename_or_io, offset: offset)
      end
    end
    ...
    def get_decompressor
      ...
      decompressor_class = ::BimTools::Zip::Decompressor.find_by_compression_method(
