 ...
 module Zip
  class CentralDirectory
    ...
    def read_local_extra_field(io)
      buf = io.read(::BimTools::Zip::LOCAL_ENTRY_STATIC_HEADER_LENGTH) || ''
      return '' unless buf.bytesize == ::BimTools::Zip::LOCAL_ENTRY_STATIC_HEADER_LENGTH

      head, _, _, _, _, _, _, _, _, _, n_len, e_len = buf.unpack('VCCvvvvVVVvv')
      return '' unless head == ::BimTools::Zip::LOCAL_ENTRY_SIGNATURE
