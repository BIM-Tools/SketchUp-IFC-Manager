  ...
  class OutputStream
    ...
    def initialize(file_name, stream: false, encrypter: nil)
      ...
      @output_stream = if stream
                         iostream = BimTools::Zip::RUNNING_ON_WINDOWS ? @file_name : @file_name.dup
    ...
    def put_next_entry(
      ...
      compression_method = Entry::DEFLATED, level = BimTools::Zip.default_compression
    )
    ...
    def get_compressor(entry)
      ...
      when Entry::DEFLATED
        ::BimTools::Zip::Deflater.new(@output_stream, entry.compression_level, @encrypter)
      when Entry::STORED
