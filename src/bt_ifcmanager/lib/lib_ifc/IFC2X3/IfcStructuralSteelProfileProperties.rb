#  IfcStructuralSteelProfileProperties.rb
#
...
require_relative('IfcStructuralProfileProperties.rb')

module BimTools
 module IFC2X3
  class IfcStructuralSteelProfileProperties < IfcStructuralProfileProperties
    attr_accessor :ifc_id, :shearareaz, :shearareay, :plasticshapefactory, :plasticshapefactorz
    include Step 
    def initialize( ifc_model, sketchup=nil, *args ) 
      @ifc_id = ifc_model.add( self ) unless self.class < IfcStructuralSteelProfileProperties
      super
    end # def initialize 
    def properties()
  ...
  end # class IfcStructuralSteelProfileProperties
 end # module IFC2X3
end # module BimTools
