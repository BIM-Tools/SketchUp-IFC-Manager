#  IfcExternallyDefinedSurfaceStyle.rb
#
 ...
 module IFC2X3
  class IfcExternallyDefinedSurfaceStyle < IfcExternalReference
    ...
    def initialize( ifc_model, sketchup=nil, *args ) 
      @ifc_id = ifc_model.add( self ) unless self.class < IfcExternallyDefinedSurfaceStyle
      super
    end # def initialize 
    def properties()
      return ["Location", "ItemReference", "Name"]
    end # def properties
  end # class IfcExternallyDefinedSurfaceStyle
 end # module IFC2X3
end # module BimTools
