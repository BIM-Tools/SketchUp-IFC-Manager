...
- Read the PDF documentation [Dutch: Basis ILS for SketchUp](docs/manuals/SketchUp_BIM%20basis%20ILS%202.0-handleiding_ppt.pdf) or [English: BIM basic IDM](docs/manuals/ILS_Native_SketchUp_v2.1%20ENG.PDF)
